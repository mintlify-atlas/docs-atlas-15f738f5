...
<CardGroup cols={2}>
  <Card title="Serper" icon="magnifying-glass" href="/docs/desktop/mcp-examples/search/serper">
    Google search integration with 2,500 free searches/month
  </Card>
  <Card title="Exa" icon="search" href="/docs/desktop/mcp-examples/search/exa">
    AI-powered semantic search engine
  </Card>
  <Card title="Browser MCP" icon="browser" href="/docs/desktop/mcp-examples/browser/browserbase">
    Automate web browsing and data extraction
  </Card>
  <Card title="Octagon" icon="graduation-cap" href="/docs/desktop/mcp-examples/deepresearch/octagon">
...
<CardGroup cols={2}>
  <Card title="Todoist" icon="check-square" href="/docs/desktop/mcp-examples/productivity/todoist">
    Task management and to-do lists
  </Card>
  <Card title="Linear" icon="list" href="/docs/desktop/mcp-examples/productivity/linear">
    Issue tracking and project management
  </Card>
  <Card title="Canva" icon="palette" href="/docs/desktop/mcp-examples/design/canva">
...
<CardGroup cols={2}>
  <Card title="Jupyter" icon="code" href="/docs/desktop/mcp-examples/data-analysis/jupyter">
    Execute Python code in Jupyter notebooks
  </Card>
  <Card title="E2B" icon="terminal" href="/docs/desktop/mcp-examples/data-analysis/e2b">
...
<CardGroup cols={2}>
  <Card title="MCP Examples" icon="books" href="/docs/desktop/mcp-examples/search/serper">
